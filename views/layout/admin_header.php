    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <div class="sidebar-menu">
            ...
            $menuGroups = [
                ...
                'pengguna' => [
                    'label' => 'Pengguna', 'icon' => 'bi-people-fill',
                    'keys' => ['siswa', 'admin', 'konsultasi'],
                    'items' => [
                        ['adminSiswa', 'siswa', 'bi-people', 'Master Pengguna'],
                        ['adminAdmin', 'admin', 'bi-person-badge', 'Master Admin'],
                        ['adminKonsultasi', 'konsultasi', 'bi-chat-square-text', 'Master Konsultasi'],
                    ],
                ],
                'konten' => [
                    'label' => 'Konten', 'icon' => 'bi-layout-text-window-reverse',
                    'keys' => ['slider', 'artikel', 'testimoni', 'pengembang'],
                    'items' => [
                        ['adminSlider', 'slider', 'bi-images', 'Slider'],
                ...
                'sistem' => [
                    'label' => 'Laporan & Sistem', 'icon' => 'bi-gear-wide-connected',
                    'keys' => ['laporan', 'backup', 'pengaturan', 'log'],
                    'items' => [
